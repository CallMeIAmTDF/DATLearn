                            ...
                            <div class="swiper-slide !tw-w-[85%] !tw-min-h-[32.3rem] sm:!tw-w-[550px] tw-mx-auto tw-pointer-events-auto swiper-slide-active"
                                ...
                                <div
                                    ...
                                    <div class=" tw-w-full !tw-border-[#00000020] md:tw-pb-7 tw-pb-1">
                                        ...
                                        <div
                                            ...
                                            <h6
                                                ...
                                                Đâu là đáp án đúng?</h6>
                                            <div class="tw-flex tw-items-center tw-flex-grow">
                                                <h5
                                                    class="tw-text-base tw-leading-[1.4rem] sm:tw-text-[1.15rem] sm:tw-leading-[1.7rem] !tw-text-white tw-font-medium sm:tw-px-6 tw-px-2 tw-text-center tw-self-center">
                                                    ${this.getAttribute('question')}</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="sm:tw-p-5 tw-p-0">
                                            <div class=" tw-rounded-2xl tw-border tw-border-solid tw-cursor-pointer tw-flex tw-items-center tw-py-3 tw-px-4 tw-mb-3 tw-border-[#dee2e6] tw-bg-white"
                                                onclick="choose(this)">
                                                <div class="tw-p-0 tw-text-base tw-font-text-reqular ">${this.getAttribute('A')}</div>
                                            </div>
                                            <div class=" tw-rounded-2xl tw-border tw-border-solid tw-cursor-pointer tw-flex tw-items-center tw-py-3 tw-px-4 tw-mb-3 tw-border-[#dee2e6] tw-bg-white"
                                                onclick="choose(this)">
                                                <div class="tw-p-0 tw-text-base tw-font-text-reqular ">${this.getAttribute('B')}</div>
                                            </div>
                                            <div class=" tw-rounded-2xl tw-border tw-border-solid tw-cursor-pointer tw-flex tw-items-center tw-py-3 tw-px-4 tw-mb-3 tw-border-[#dee2e6] tw-bg-white"
                                                onclick="choose(this)">
                                                <div class="tw-p-0 tw-text-base tw-font-text-reqular ">${this.getAttribute('C')}
                                                </div>
                                            </div>
                                            <div class=" tw-rounded-2xl tw-border tw-border-solid tw-cursor-pointer tw-flex tw-items-center tw-py-3 tw-px-4 tw-mb-3 tw-border-[#dee2e6] tw-bg-white"
                                                onclick="choose(this)">
                                                <div class="tw-p-0 tw-text-base tw-font-text-reqular ">${this.getAttribute('D')}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" tw-text-right sm:tw-px-12 tw-px-4 tw-pt-2 tw-pb-6 tw-w-full"><button
                                            ...
                                            onclick="done('${this.getAttribute('wid')}')">Done</button>
                                    </div>
                                </div>
                            </div>
                        </div>
